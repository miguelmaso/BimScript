...
from Autodesk.Revit.DB import Document, Element, ElementId, BoundingBoxXYZ, Category, DesignOption, XYZ, GeometryElement, Location, Parameter, ParameterSet, ParameterMap, WorksetId, ElementType, Curve, Transform, Reference, Face, CurveLoop, Plane, Line, View3D, View, CurveElement, CurveElementType, SketchPlane, IndependentTag, LeaderEndCondition, LinkElementId, TagOrientation, RoundingMethod, ElementSlowFilter, ConnectorManager, ParameterValue, BarTypeDiameterOptions, UV, ExternalDefinition, DefinitionFile, ForgeTypeId, Subelement, FamilyInstance, CurveArray, FamilySymbol, Family
from System import Guid, IDisposable
from System.Collections.Generic import IList_1, ICollection_1, IDictionary_2, ISet_1, IEnumerable_1, IEnumerator_1
...
class AnalyticalConsistencyChecking(abc.ABC):
    @staticmethod
...
class AnalyticalModel(Element):
    ...
    def RigidLinksOption(self, value: AnalyticalRigidLinksOption) -> AnalyticalRigidLinksOption: ...
    @property
    def UniqueId(self) -> str: ...
    @property
    def VersionGuid(self) -> Guid: ...
    ...
    def GetAnalyticalModelSketchComponents(self) -> IList_1[AnalyticalModelSketchComponent]: ...
    def GetAnalyticalModelSupports(self) -> IList_1[AnalyticalModelSupport]: ...
    def GetAnalyzeAs(self) -> AnalyzeAs: ...
    def GetApproximationDeviation(self) -> float: ...
    def GetAutoDetectMatchedElements(self, direction: AnalyticalDirection) -> ICollection_1[ElementId]: ...
    def GetCurve(self) -> Curve: ...
    def GetCurves(self, curveType: AnalyticalCurveType) -> IList_1[Curve]: ...
    def GetElementId(self) -> ElementId: ...
    def GetLocalCoordinateSystem(self) -> Transform: ...
    def GetManualAdjustmentMatchedElements(self) -> ICollection_1[ElementId]: ...
...
class AnalyticalModelColumn(AnalyticalModelStick):
    ...
    def BaseExtension(self, value: StickElementExtension) -> StickElementExtension: ...
    @property
    def BaseExtensionMethod(self) -> AnalyticalAlignmentMethod: ...
    @BaseExtensionMethod.setter
    def BaseExtensionMethod(self, value: AnalyticalAlignmentMethod) -> AnalyticalAlignmentMethod: ...
    @property
    def BaseExtensionPlaneId(self) -> ElementId: ...
    @BaseExtensionPlaneId.setter
    def BaseExtensionPlaneId(self, value: ElementId) -> ElementId: ...
    @property
    def BoundingBox(self) -> BoundingBoxXYZ: ...
    @property
    def Category(self) -> Category: ...
    ...
    @TopExtension.setter
    def TopExtension(self, value: StickElementExtension) -> StickElementExtension: ...
    @property
    def TopExtensionMethod(self) -> AnalyticalAlignmentMethod: ...
    @TopExtensionMethod.setter
    def TopExtensionMethod(self, value: AnalyticalAlignmentMethod) -> AnalyticalAlignmentMethod: ...
    @property
    def TopExtensionPlaneId(self) -> ElementId: ...
    @TopExtensionPlaneId.setter
    def TopExtensionPlaneId(self, value: ElementId) -> ElementId: ...
    @property
    def UniqueId(self) -> str: ...
    @property
    def VersionGuid(self) -> Guid: ...
...
class AnalyticalModelSketchComponent(IDisposable):
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
    ...
    def GetAutoDetectMatchedElements(self) -> ICollection_1[ElementId]: ...
...
class AnalyticalModelStick(AnalyticalModel):
    ...
    def GetReleases(self, start: bool, fx: clr.Reference[bool], fy: clr.Reference[bool], fz: clr.Reference[bool], mx: clr.Reference[bool], my: clr.Reference[bool], mz: clr.Reference[bool]) -> None: ...
    ...
    # Skipped GetLocalCoordinateSystem due to it being static, abstract and generic.

    GetLocalCoordinateSystem : GetLocalCoordinateSystem_MethodGroup
    class GetLocalCoordinateSystem_MethodGroup:
        @typing.overload
        def __call__(self, parameter: float) -> Transform:...
        @typing.overload
        def __call__(self, point: XYZ) -> Transform:...
    ...
    # Skipped SetProjection due to it being static, abstract and generic.

    SetProjection : SetProjection_MethodGroup
    class SetProjection_MethodGroup:
        @typing.overload
        def __call__(self, selector: AnalyticalElementSelector, projectionY: StickElementProjectionY, projectionZ: StickElementProjectionZ) -> None:...
        @typing.overload
        def __call__(self, selector: AnalyticalElementSelector, projectionY: StickElementProjectionY, planeIdZ: ElementId) -> None:...
        @typing.overload
        def __call__(self, selector: AnalyticalElementSelector, planeIdY: ElementId, projectionZ: StickElementProjectionZ) -> None:...
        @typing.overload
        def __call__(self, selector: AnalyticalElementSelector, planeIdY: ElementId, planeIdZ: ElementId) -> None:...



class AnalyticalModelSupport(IDisposable):
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
    def GetCurve(self) -> Curve: ...
...
class AnalyticalModelSurface(AnalyticalModel):
    ...
    def AlignmentMethod(self, value: AnalyticalAlignmentMethod) -> AnalyticalAlignmentMethod: ...
    @property
    def AssemblyInstanceId(self) -> ElementId: ...
    @property
    def BottomExtension(self) -> SurfaceElementExtension: ...
    @BottomExtension.setter
    def BottomExtension(self, value: SurfaceElementExtension) -> SurfaceElementExtension: ...
    @property
    def BottomExtensionMethod(self) -> AnalyticalAlignmentMethod: ...
    @BottomExtensionMethod.setter
    def BottomExtensionMethod(self, value: AnalyticalAlignmentMethod) -> AnalyticalAlignmentMethod: ...
    @property
    def BottomExtensionPlaneId(self) -> ElementId: ...
    @BottomExtensionPlaneId.setter
    def BottomExtensionPlaneId(self, value: ElementId) -> ElementId: ...
    @property
    def BoundingBox(self) -> BoundingBoxXYZ: ...
    @property
    def Category(self) -> Category: ...
    ...
    def ProjectionPlaneZ(self, value: ElementId) -> ElementId: ...
    @property
    def ProjectionZ(self) -> SurfaceElementProjectionZ: ...
    @ProjectionZ.setter
    def ProjectionZ(self, value: SurfaceElementProjectionZ) -> SurfaceElementProjectionZ: ...
    @property
    def RigidLinksOption(self) -> AnalyticalRigidLinksOption: ...
    @RigidLinksOption.setter
    def RigidLinksOption(self, value: AnalyticalRigidLinksOption) -> AnalyticalRigidLinksOption: ...
    ...
    @TopExtension.setter
    def TopExtension(self, value: SurfaceElementExtension) -> SurfaceElementExtension: ...
    @property
    def TopExtensionMethod(self) -> AnalyticalAlignmentMethod: ...
    @TopExtensionMethod.setter
    def TopExtensionMethod(self, value: AnalyticalAlignmentMethod) -> AnalyticalAlignmentMethod: ...
    ...
    @property
    def WorksetId(self) -> WorksetId: ...
    def GetHiddenOpenings(self, openingsIds: clr.Reference[ICollection_1[ElementId]]) -> None: ...
    def GetLocalCoordinateSystem(self, point: XYZ) -> Transform: ...
    def GetLoops(self, loopType: AnalyticalLoopType) -> IList_1[CurveLoop]: ...
    def GetOpeningLoops(self, openingId: ElementId) -> IList_1[CurveLoop]: ...
    def GetOpenings(self, openingsIds: clr.Reference[ICollection_1[ElementId]]) -> None: ...
    ...
    def SetLoops(self, loopType: AnalyticalLoopType, newLoops: IList_1[CurveLoop]) -> bool: ...
...
class AnalyticalSupportChecking(abc.ABC):
    @staticmethod
...
class AreaLoad(LoadBase):
    ...
    class Create_MethodGroup:
        ...
        @typing.overload
        def __call__(self, aDoc: Document, host: AnalyticalModelSurface, forceVector: XYZ, symbol: AreaLoadType) -> AreaLoad:...
        @typing.overload
...
class FabricReinSpanSymbol(IndependentTag):
    ...
    @property
    def TaggedElementId(self) -> LinkElementId: ...
    @property
    def TaggedLocalElementId(self) -> ElementId: ...
    @property
...
class LineLoad(LoadBase):
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, aDoc: Document, host: AnalyticalModelStick, forceVector1: XYZ, momentVector1: XYZ, symbol: LineLoadType) -> LineLoad:...
        @typing.overload
        def __call__(self, aDoc: Document, host: AnalyticalModelSurface, curveIndex: int, forceVector1: XYZ, momentVector1: XYZ, symbol: LineLoadType) -> LineLoad:...
        @typing.overload
...
class PointLoad(LoadBase):
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, aDoc: Document, host: AnalyticalModel, forceVector: XYZ, momentVector: XYZ, symbol: PointLoadType) -> PointLoad:...
        @typing.overload
        def __call__(self, aDoc: Document, host: AnalyticalModelStick, selector: AnalyticalElementSelector, forceVector: XYZ, momentVector: XYZ, symbol: PointLoadType) -> PointLoad:...
        @typing.overload
...
class RebarBarType(ElementType):
    ...
    @BarDiameter.setter
    def BarDiameter(self, value: float) -> float: ...
    @property
...
class StructuralSettings(Element):
    ...
    def CheckAnalyticalModelAsset(self, value: bool) -> bool: ...
    @property
    def CreatedPhaseId(self) -> ElementId: ...
    @CreatedPhaseId.setter
    def CreatedPhaseId(self, value: ElementId) -> ElementId: ...
    ...
    def DifferentiateAnalyticalEnds(self, value: bool) -> bool: ...
    @property
    def Document(self) -> Document: ...
    @property
    def Geometry(self) -> GeometryElement: ...
