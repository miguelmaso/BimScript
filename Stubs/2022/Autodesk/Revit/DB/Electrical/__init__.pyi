...
from Autodesk.Revit.DB import ElementId, BoundingBoxXYZ, Category, ConnectorManager, XYZ, DesignOption, Document, GeometryElement, Location, MEPSystem, Parameter, ParameterSet, ParameterMap, Level, WorksetId, MEPCurve, Element, MEPSize, MEPCurveType, FamilySymbol, JunctionType, RoutingPreferenceManager, ConnectorProfileType, TableCellCombinedParameterData, APIObject, ElementType, MEPModel, FamilyInstance, Connector, ElementSet, View, TableData, SectionType, TableSectionData, TableView, ViewDetailLevel, ViewDiscipline, DisplayStyle, BoundingBoxUV, PartsVisibility, SketchPlane, SunAndShadowSettings, TemporaryViewModes, ViewType
from System import Guid, IDisposable
from System.Collections.Generic import IEnumerator_1, IEnumerable_1, IList_1, KeyValuePair_2, ICollection_1
...
class ElectricalSystemSet(APIObject, IEnumerable):
    def __init__(self) -> None: ...
    @property
    def IsEmpty(self) -> bool: ...
    @property
...
class ElectricalSystemSetIterator(APIObject, IEnumerator, abc.ABC):
    def __init__(self) -> None: ...
    @property
    def Current(self) -> typing.Any: ...
    @property
...
class TemperatureRatingType(ElementType):
    ...
    # Skipped AddCorrectionFactor due to it being static, abstract and generic.

    AddCorrectionFactor : AddCorrectionFactor_MethodGroup
    class AddCorrectionFactor_MethodGroup:
        def __call__(self, temperature: float, factor: float) -> CorrectionFactor:...
        # Method AddCorrectionFactor(temperature : Int64, factor : Double) was skipped since it collides with above method
