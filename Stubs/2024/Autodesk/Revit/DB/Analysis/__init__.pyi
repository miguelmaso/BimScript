...
from Autodesk.Revit.DB import Color, ElementId, Element, BoundingBoxXYZ, Category, DesignOption, Document, GeometryElement, Location, Parameter, ParameterSet, ParameterMap, WorksetId, LinkElementId, XYZ, ElementType, UV, CurveLoop, Reference, ConnectorDomainType, MEPSystemClassification, View, Curve, Transform, Face, ValueAtPointBase, ViewDetailLevel, ViewDiscipline, DisplayStyle, Level, BoundingBoxUV, PartsVisibility, SketchPlane, SunAndShadowSettings, TemporaryViewModes, ViewType
from System.Collections.Generic import IList_1, ICollection_1, IDictionary_2
from Autodesk.Revit.DB.Plumbing import PipeFlowState
...
class ConstructionType(typing.SupportsInt):
    ...
    UndergroundWall : ConstructionType # 10
...
class EnergyAnalysisConstruction(Element):
    ...
    @property
    def WorksetId(self) -> WorksetId: ...
    def GetMaterialIds(self) -> IList_1[ElementId]: ...
...
class EnergyAnalysisOpening(Element):
    ...
    def GetPolyloops(self) -> IList_1[Polyloop]: ...
...
class EnergyAnalysisWindowType(Element):
    ...
    @property
    def WorksetId(self) -> WorksetId: ...
    def GetSolarHeatGainCoefficientsForSolarIndicientAngles(self) -> IDictionary_2[float, float]: ...
...
class EnergyDataSettings(Element):
    ...
    def UseCurrentViewOnly(self, value: bool) -> bool: ...
    @property
...
class gbXMLSurfaceType(typing.SupportsInt):
    ...
    ExposedFloor : gbXMLSurfaceType # 4
    Shade : gbXMLSurfaceType # 5
    UndergroundWall : gbXMLSurfaceType # 6
    UndergroundSlab : gbXMLSurfaceType # 7
    Ceiling : gbXMLSurfaceType # 8
    SurfaceAir : gbXMLSurfaceType # 9
    UndergroundCeiling : gbXMLSurfaceType # 10
    RaisedFloor : gbXMLSurfaceType # 11
    SlabOnGrade : gbXMLSurfaceType # 12
    NoOfSurfaceTypes : gbXMLSurfaceType # 13
...
class MEPAnalyticalModelData(IDisposable):
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
    @staticmethod
...
class MEPAnalyticalNode(IDisposable):
    @property
    def Id(self) -> int: ...
    @property
...
class MEPAnalyticalSegment(IDisposable):
    @property
    def Area(self) -> float: ...
    @property
...
class MEPAnalyticalSegmentType(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Undefined : MEPAnalyticalSegmentType # 0
    Segment : MEPAnalyticalSegmentType # 1
    Fitting : MEPAnalyticalSegmentType # 2
    Pump : MEPAnalyticalSegmentType # 3
    Loss : MEPAnalyticalSegmentType # 4
    SourceEquipment : MEPAnalyticalSegmentType # 5


class MEPNetworkIterator(IDisposable):
    @typing.overload
    def __init__(self, pADoc: Document, seed: MEPAnalyticalModelData, eDomain: ConnectorDomainType) -> None: ...
    @typing.overload
    def __init__(self, pADoc: Document, startNode: MEPAnalyticalNode, startSegment: MEPAnalyticalSegment) -> None: ...
    @property
    ...
    def SystemClassification(self, value: MEPSystemClassification) -> MEPSystemClassification: ...
    @property
    def SystemId(self) -> ElementId: ...
    @SystemId.setter
    def SystemId(self, value: ElementId) -> ElementId: ...
    def Dispose(self) -> None: ...
    def End(self) -> bool: ...
...
class MEPNetworkSegmentData(IDisposable):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, other: MEPNetworkSegmentData) -> None: ...
    @property
    ...
    def Dispose(self) -> None: ...
    def GetDownstreamSegments(self) -> IList_1[MEPNetworkSegmentId]: ...
    def GetUpstreamSegments(self) -> IList_1[MEPNetworkSegmentId]: ...
    def IsValid(self) -> bool: ...


class MEPNetworkSegmentId(IDisposable):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, idElem: ElementId, segment: int) -> None: ...
    @property
    def ElementId(self) -> ElementId: ...
    @ElementId.setter
    def ElementId(self, value: ElementId) -> ElementId: ...
    @property
    def IsValidObject(self) -> bool: ...
    @property
    def SegmentId(self) -> int: ...
    @SegmentId.setter
    def SegmentId(self, value: int) -> int: ...
    def Dispose(self) -> None: ...
    def IsValid(self) -> bool: ...
