...
class AnalyticalEquipmentLoadData(AnalyticalDistributionNodePropertyData):
    ...
    @LoadSet.setter
    def LoadSet(self, value: ElementId) -> ElementId: ...
    @property
...
class ElectricalAnalyticalLoadSet(Element):
    ...
    def QuantityOnStandBy(self, value: int) -> int: ...
    @property
    ...
    def GetLoadIds(self) -> ISet_1[ElementId]: ...
...
class ElectricalAnalyticalNode(Element):
    ...
    def GetAllDownstreamLoadIds(self) -> ISet_1[ElementId]: ...
