...
from Autodesk.Revit.DB import Element, ElementId, BoundingBoxXYZ, Category, DesignOption, Document, GeometryElement, Location, Parameter, ParameterSet, ParameterMap, WorksetId, Curve, Reference, Transform, XYZ, ElementType, CurveLoop, Line, View, CurveElement, CurveElementType, SketchPlane, ICustomFieldProperties, IndependentTag, LeaderEndCondition, LeadersPresentationMode, TagOrientation, LinkElementId, RoundingMethod, ElementSlowFilter, ConnectorManager, ParameterValue, BarTypeDiameterOptions, Face, UV, ExternalDefinition, DefinitionFile, ForgeTypeId, Subelement, FamilyInstance, CurveArray, FamilySymbol, Family
...
class AlignedFreeFormSetOrientationOptions(typing.SupportsInt):
    @typing.overload
    ...
    # Values:
    AlignedToDistributionPath : AlignedFreeFormSetOrientationOptions # 0
    Vertical : AlignedFreeFormSetOrientationOptions # 1
    ParallelToFace : AlignedFreeFormSetOrientationOptions # 2
    PerpendicularToFace : AlignedFreeFormSetOrientationOptions # 3
...
class AnalyticalToPhysicalAssociationManager(Element):
    ...
    def GetAssociatedElementIds(self, elementId: ElementId) -> ISet_1[ElementId]: ...
    ...
    # Skipped AddAssociation due to it being static, abstract and generic.

    AddAssociation : AddAssociation_MethodGroup
    class AddAssociation_MethodGroup:
        @typing.overload
        def __call__(self, analyticalElementIds: ISet_1[ElementId], physicalElementIds: ISet_1[ElementId]) -> None:...
        @typing.overload
        def __call__(self, analyticalElementId: ElementId, physicalElementId: ElementId) -> None:...
...
class AreaLoad(LoadBase):
    ...
    def WorksetId(self) -> WorksetId: ...
    @staticmethod
    def AreCurveLoopsValid(loops: IList_1[CurveLoop]) -> bool: ...
    def GetLoops(self) -> IList_1[CurveLoop]: ...
    def GetRefPoint(self, index: int) -> XYZ: ...
    @staticmethod
    def IsCurveLoopsInsideHostBoundaries(doc: Document, hostId: ElementId, loops: IList_1[CurveLoop]) -> bool: ...
    @staticmethod
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, forceVector: XYZ, symbol: AreaLoadType) -> AreaLoad:...
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, loops: IList_1[CurveLoop], forceVector: XYZ, symbol: AreaLoadType) -> AreaLoad:...
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, loops: IList_1[CurveLoop], forceVectors: IList_1[XYZ], refPointCurveIndexes: IList_1[int], refPointCurveEnds: IList_1[int], symbol: AreaLoadType) -> AreaLoad:...
...
class BendingDetailAngularDimensionsDisplayOptions(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    AllAngles : BendingDetailAngularDimensionsDisplayOptions # 0
    Exclude90Degrees : BendingDetailAngularDimensionsDisplayOptions # 1


class BendingDetailAngularDimensionsMeasurementOptions(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Inside : BendingDetailAngularDimensionsMeasurementOptions # 0
    Outside : BendingDetailAngularDimensionsMeasurementOptions # 1


class BendingDetailBendDiameterDimensionType(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Radial : BendingDetailBendDiameterDimensionType # 0
    Diameter : BendingDetailBendDiameterDimensionType # 1


class BendingDetailCustomFieldMultipleValuesIndicatorOptions(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Varying : BendingDetailCustomFieldMultipleValuesIndicatorOptions # 0
    MinimumMaximum : BendingDetailCustomFieldMultipleValuesIndicatorOptions # 1


class BendingDetailCustomFieldProperties(IDisposable, ICustomFieldProperties):
    @property
    ...
    def AngularDimensionsDisplayOption(self, value: BendingDetailAngularDimensionsDisplayOptions) -> BendingDetailAngularDimensionsDisplayOptions: ...
    @property
    def AngularDimensionsEnabled(self) -> bool: ...
    @AngularDimensionsEnabled.setter
    def AngularDimensionsEnabled(self, value: bool) -> bool: ...
    @property
    def AngularDimensionsForHooksEnabled(self) -> bool: ...
    @AngularDimensionsForHooksEnabled.setter
    def AngularDimensionsForHooksEnabled(self, value: bool) -> bool: ...
    @property
    ...
    def AngularDimensionsMeasurementOptions(self, value: BendingDetailAngularDimensionsMeasurementOptions) -> BendingDetailAngularDimensionsMeasurementOptions: ...
    @property
    def AngularDimensionsOffset(self) -> float: ...
    @AngularDimensionsOffset.setter
    def AngularDimensionsOffset(self, value: float) -> float: ...
    @property
    def AngularDimensionTextPosition(self) -> BendingDetailDimensionTextPosition: ...
    @AngularDimensionTextPosition.setter
    def AngularDimensionTextPosition(self, value: BendingDetailDimensionTextPosition) -> BendingDetailDimensionTextPosition: ...
    @property
    def AngularDimensionTypeId(self) -> ElementId: ...
    @AngularDimensionTypeId.setter
    def AngularDimensionTypeId(self, value: ElementId) -> ElementId: ...
    @property
    def BendDiameterDimensionsEnabled(self) -> bool: ...
    @BendDiameterDimensionsEnabled.setter
    def BendDiameterDimensionsEnabled(self, value: bool) -> bool: ...
    @property
    def BendDiameterDimensionsForHooksEnabled(self) -> bool: ...
    @BendDiameterDimensionsForHooksEnabled.setter
    def BendDiameterDimensionsForHooksEnabled(self, value: bool) -> bool: ...
    @property
    def BendDiameterDimensionsForSegmentsEnabled(self) -> bool: ...
    @BendDiameterDimensionsForSegmentsEnabled.setter
    def BendDiameterDimensionsForSegmentsEnabled(self, value: bool) -> bool: ...
    @property
    def BendDiameterDimensionType(self) -> BendingDetailBendDiameterDimensionType: ...
    @BendDiameterDimensionType.setter
    def BendDiameterDimensionType(self, value: BendingDetailBendDiameterDimensionType) -> BendingDetailBendDiameterDimensionType: ...
    @property
    def DiameterDimensionTypeId(self) -> ElementId: ...
    @DiameterDimensionTypeId.setter
    def DiameterDimensionTypeId(self, value: ElementId) -> ElementId: ...
    @property
    def IsValidObject(self) -> bool: ...
    @property
    def LineStyleId(self) -> ElementId: ...
    @LineStyleId.setter
    def LineStyleId(self, value: ElementId) -> ElementId: ...
    @property
    ...
    def MultipleValuesIndicatorOption(self, value: BendingDetailCustomFieldMultipleValuesIndicatorOptions) -> BendingDetailCustomFieldMultipleValuesIndicatorOptions: ...
    @property
    def OrthogonalAndOverallDimesionsEnabled(self) -> bool: ...
    @OrthogonalAndOverallDimesionsEnabled.setter
    def OrthogonalAndOverallDimesionsEnabled(self, value: bool) -> bool: ...
    @property
    def ParametersDisplayOption(self) -> BendingDetailDisplayParametersOptions: ...
    @ParametersDisplayOption.setter
    def ParametersDisplayOption(self, value: BendingDetailDisplayParametersOptions) -> BendingDetailDisplayParametersOptions: ...
    @property
    def RadialDimensionTypeId(self) -> ElementId: ...
    @RadialDimensionTypeId.setter
    def RadialDimensionTypeId(self, value: ElementId) -> ElementId: ...
    @property
    def RepresentaionOf3DShapes(self) -> BendingDetailFor3DShapesOptions: ...
    @RepresentaionOf3DShapes.setter
    def RepresentaionOf3DShapes(self, value: BendingDetailFor3DShapesOptions) -> BendingDetailFor3DShapesOptions: ...
    @property
    def SegmentLengthDimensionsEnabled(self) -> bool: ...
    @SegmentLengthDimensionsEnabled.setter
    def SegmentLengthDimensionsEnabled(self, value: bool) -> bool: ...
    @property
    def SegmentLengthDimensionsForHooksEnabled(self) -> bool: ...
    @SegmentLengthDimensionsForHooksEnabled.setter
    def SegmentLengthDimensionsForHooksEnabled(self, value: bool) -> bool: ...
    @property
    def SegmentLengthDimensionsOffset(self) -> float: ...
    @SegmentLengthDimensionsOffset.setter
    def SegmentLengthDimensionsOffset(self, value: float) -> float: ...
    @property
    def SegmentLengthDimensionTextPosition(self) -> BendingDetailDimensionTextPosition: ...
    @SegmentLengthDimensionTextPosition.setter
    def SegmentLengthDimensionTextPosition(self, value: BendingDetailDimensionTextPosition) -> BendingDetailDimensionTextPosition: ...
    @property
    def SegmentLengthDimensionTypeId(self) -> ElementId: ...
    @SegmentLengthDimensionTypeId.setter
    def SegmentLengthDimensionTypeId(self, value: ElementId) -> ElementId: ...
    @property
    def SegmentLengthsDisplayOption(self) -> BendingDetailSegmentLengthsDisplayOptions: ...
    @SegmentLengthsDisplayOption.setter
    def SegmentLengthsDisplayOption(self, value: BendingDetailSegmentLengthsDisplayOptions) -> BendingDetailSegmentLengthsDisplayOptions: ...
    @property
    ...
    def SegmentLengthsForArcsDisplayOption(self, value: BendingDetailSegmentLengthsDisplayOptions) -> BendingDetailSegmentLengthsDisplayOptions: ...
    @property
    def SegmentsRepresentation(self) -> BendingDetailSegmentsRepresentation: ...
    @SegmentsRepresentation.setter
    def SegmentsRepresentation(self, value: BendingDetailSegmentsRepresentation) -> BendingDetailSegmentsRepresentation: ...
    def AreEqualTo(self, otherProperties: ICustomFieldProperties) -> bool: ...
    def Dispose(self) -> None: ...


class BendingDetailDimensionTextPosition(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Default : BendingDetailDimensionTextPosition # 0
    OutsideOfDimensionLine : BendingDetailDimensionTextPosition # 1


class BendingDetailDisplayParametersOptions(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    ByValue : BendingDetailDisplayParametersOptions # 0
    ByName : BendingDetailDisplayParametersOptions # 1


class BendingDetailFor3DShapesOptions(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    IsometricView : BendingDetailFor3DShapesOptions # 0
    PlanView : BendingDetailFor3DShapesOptions # 1


class BendingDetailLevelOfDetail(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    ByView : BendingDetailLevelOfDetail # 0
    Coarse : BendingDetailLevelOfDetail # 1
    Fine : BendingDetailLevelOfDetail # 2


class BendingDetailSegmentLengthsDisplayOptions(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Text : BendingDetailSegmentLengthsDisplayOptions # 0
    Dimension : BendingDetailSegmentLengthsDisplayOptions # 1


class BendingDetailSegmentsRepresentation(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Standard : BendingDetailSegmentsRepresentation # 0
    Unfold : BendingDetailSegmentsRepresentation # 1
    Offset : BendingDetailSegmentsRepresentation # 2


class BendingDetailTypeMultipleValuesIndicatorOptions(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    FromOneBar : BendingDetailTypeMultipleValuesIndicatorOptions # 0
    MinimumMaximum : BendingDetailTypeMultipleValuesIndicatorOptions # 1
...
class LineLoad(LoadBase):
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, forceVector1: XYZ, momentVector1: XYZ, symbol: LineLoadType) -> LineLoad:...
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, curveIndex: int, forceVector1: XYZ, momentVector1: XYZ, symbol: LineLoadType) -> LineLoad:...
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, curve: Curve, forceVector1: XYZ, momentVector1: XYZ, symbol: LineLoadType) -> LineLoad:...
...
class PointLoad(LoadBase):
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, selector: AnalyticalElementSelector, forceVector: XYZ, momentVector: XYZ, symbol: PointLoadType) -> PointLoad:...
        @typing.overload
        def __call__(self, document: Document, hostElemId: ElementId, point: XYZ, forceVector: XYZ, momentVector: XYZ, symbol: PointLoadType) -> PointLoad:...
...
class RebarBendingDetail(abc.ABC):
    @staticmethod
...
class RebarBendingDetailType(ElementType):
    ...
    @DetailLevel.setter
    def DetailLevel(self, value: BendingDetailLevelOfDetail) -> BendingDetailLevelOfDetail: ...
    @property
    def DiameterDimensionTypeId(self) -> ElementId: ...
    @DiameterDimensionTypeId.setter
    def DiameterDimensionTypeId(self, value: ElementId) -> ElementId: ...
    ...
    @MultipleValuesIndicatorOption.setter
    def MultipleValuesIndicatorOption(self, value: BendingDetailTypeMultipleValuesIndicatorOptions) -> BendingDetailTypeMultipleValuesIndicatorOptions: ...
    @property
    def Name(self) -> None: ...
    @Name.setter
    def Name(self, value: str) -> None: ...
...
class RebarFreeFormAccessor(IDisposable):
    ...
    def AlignedFreeFormSetOrientationOptions(self, value: AlignedFreeFormSetOrientationOptions) -> AlignedFreeFormSetOrientationOptions: ...
    @property
    def CycleCounter(self) -> int: ...
    @CycleCounter.setter
    def CycleCounter(self, value: int) -> int: ...
    @property
    def IsValidObject(self) -> bool: ...
    @property
...
class StructuralSettings(Element):
    ...
    def UseLoadsDisplayScaling(self, value: bool) -> bool: ...
    @property
    def VersionGuid(self) -> Guid: ...
    @property
    def ViewSpecific(self) -> bool: ...
